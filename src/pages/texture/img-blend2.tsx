...
class ImgBlend extends React.Component {
  ...
  componentDidMount() {
    ...
    var video:any = document.getElementById("bgm");
    var videoTexture:any = new THREE.VideoTexture(video);
    ...
    var bgmImg:any = new THREE.Mesh(new THREE.PlaneGeometry(20,13),new THREE.MeshLambertMaterial({
